...
describe('Test routes', () => {
  ...
  it('POST /bookmarks sends error if field missing', (done) => {
    request(app)
      .post('/bookmarks')
      .send({})
      .expect(422)
  ...
  it('POST /bookmarks sends created bookmark as json', (done) => {
    request(app)
      .post('/bookmarks')
  ...
  describe('GET /bookmarks/:id', () => {
    ...
    it('GET /bookmarks/:id sends error if id not exist', (done) => {
      request(app)
        .get('/bookmarks/idisnonexisting')
        .expect(404)
        .expect('Content-Type', /json/)
        .then(response => {
    ...
    it('GET /bookmarks/:id sends json of bookmark by id', (done) => {
      request(app)
        .get('/bookmarks/1')
        .expect(200)
        .expect('Content-Type', /json/)
